...
SETTING_DEFINITIONS = {
    ...
    "sign_in_and_directory": [
        ...
        {"key": "LDAP_ROLE_MAPPINGS", "label": "LDAP group role mappings", "type": "json", "default": "{}", "live": True},
        {
            ...
            "default": json.dumps({
                ...
                "team_name": "teamName", "user_principal_name": "userPrincipalName",
                "website": "wWWHomePage", "unix_username": "uid",
                "nis_domain": "msSFU30NisDomain", "last_bad_password_at": "badPasswordTime",
                "last_logoff_at": "lastLogoff", "lockout_at": "lockoutTime",
                "sam_account_type": "sAMAccountType",
                "given_name": "givenName", "surname": "sn", "common_name": "cn",
                "directory_created_at": "whenCreated", "directory_changed_at": "whenChanged",
                "last_logon_at": "lastLogonTimestamp", "password_last_set_at": "pwdLastSet",
                "account_expires_at": "accountExpires", "account_control": "userAccountControl",
                "bad_password_count": "badPwdCount", "logon_count": "logonCount",
                "primary_group_id": "primaryGroupID", "object_guid": "objectGUID",
                "uid_number": "uidNumber", "gid_number": "gidNumber",
                "unix_home_directory": "unixHomeDirectory", "login_shell": "loginShell",
    ...
    "email_delivery": [
        ...
        {"key": "SMTP_PROVIDER", "label": "Email provider", "type": "choice", "choices": ["generic", "google_workspace_relay", "google_workspace_app_password", "google_workspace_oauth2"], "default": "generic", "live": True},
        ...
        {"key": "SMTP_AUTH_MODE", "label": "SMTP authentication", "type": "choice", "choices": ["none", "password", "oauth2"], "default": "password", "live": True},
        ...
        {"key": "SMTP_OAUTH_CLIENT_ID", "label": "Google OAuth client ID", "type": "text", "default": "", "live": True},
        {"key": "SMTP_OAUTH_CLIENT_SECRET", "label": "Google OAuth client secret", "type": "secret", "default": "", "live": True},
        {"key": "SMTP_OAUTH_REFRESH_TOKEN", "label": "Google OAuth refresh token", "type": "secret", "default": "", "live": True},
        {"key": "SMTP_FROM", "label": "SMTP from address", "type": "email", "default": "", "live": True},
        {"key": "SMTP_FROM_NAME", "label": "SMTP sender name", "type": "text", "default": "ServiceOps", "live": True},
        {"key": "SMTP_REPLY_TO", "label": "SMTP reply-to address", "type": "email", "default": "", "live": True},
        {"key": "SMTP_TIMEOUT_SECONDS", "label": "SMTP timeout (seconds)", "type": "int", "default": "10", "min": 5, "max": 60, "live": True},
    ],
    "netbox_connection": [
