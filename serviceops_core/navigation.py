...
NAVIGATION_ENTRIES = (
    ...
    NavigationEntry("Service configuration", "Routing SLA freeze teams", "admin_section", {"section": "service-configuration"}, "admin"),
    NavigationEntry("Integrations", "Webhooks monitoring RT import delivery Notification channels delivery log Telegram Slack Teams Discord Google Chat monitoring sources", "integrations_admin", minimum_role="admin"),
    ...
    NavigationEntry("Executive approval authority", "Executive change sign-off People access", "itil_admin_section", {"section": "executive-approval"}, "admin"),
    NavigationEntry("Change freeze windows", "Blackout period schedule block Service configuration", "itil_admin_section", {"section": "change-freeze"}, "admin"),
    NavigationEntry("Service offerings", "Business service catalog Service configuration", "itil_admin_section", {"section": "service-offerings"}, "admin"),
    NavigationEntry("SLA definitions", "Service level agreement targets Service configuration", "itil_admin_section", {"section": "sla"}, "admin"),
    ...
    NavigationEntry("AI assistance", "AI services models Gemini OpenAI Claude Anthropic llama Ollama routing privacy sensitive data chatbot API key external private", "ai.settings", minimum_role="admin"),
    NavigationEntry("AI chat", "Ask AI assistant chatbot questions conversation history", "ai.chat_page"),
    NavigationEntry("Roles and permissions", "Role action policy CI class permissions access", "admin_roles", minimum_role="admin"),
    NavigationEntry("Active sessions", "Browser sessions revoke sign out devices", "admin_sessions", minimum_role="admin"),
    NavigationEntry("Notification templates", "Subject body email message content", "notification_templates_admin", minimum_role="admin"),
    NavigationEntry("Guided tours", "Onboarding walkthrough help", "guided_tours_admin", minimum_role="admin"),
    NavigationEntry("Data governance", "Retention legal hold GDPR export erasure privacy", "data_governance_admin", minimum_role="admin"),
